...
//holdall_sort/holdall_sort_context : trie les valeurs contenues dans le holdall
// selon la fonction de comparaison compar, selon la méthode du tri fusion
// et renvoie le controlleur du holdall trié.
extern holdall *holdall_sort(holdall *hold, int (*compar)(const void *,
    const void *));
extern holdall *holdall_sort_context(holdall *hold, const void *context,
