...
struct hashtable {
  ...
  size_t nslots;
  size_t nentries;
  const void *current_cell;
  const void *current_var;
  const void *current_call;
};
...
void *hashtable_getCurrentAlgo(hashtable *ht) {
  return (void *) ht->current_cell;
}

void hashtable_setCurrentAlgo(hashtable *ht, const void *ref) {
  ht->current_cell = ref;
}

void *hashtable_getCurrentCall(hashtable *ht) {
  return (void *) ht->current_call;
}

void hashtable_setCurrentCall(hashtable *ht, const void *ref) {
  ht->current_call = ref;
}

void *hashtable_getCurrentVar(hashtable *ht) {
  return (void *) ht->current_var;
}

void hashtable_setCurrentVar(hashtable *ht, const void *ref) {
  ht->current_var = ref;
}

int hashtable_entry(hashtable *ht) {
  return ht->nentries;
}
